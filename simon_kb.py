...
Open source project — https://github.com/simonxsolutions-SXS/SIMON
...
def sync_messages(hours_back: int = 48) -> int:
    ...
    for row in rows:
        ...
        sender_name = "Me" if row["is_from_me"] else resolve_name(row["sender_handle"], kb_conn)
...
if __name__ == "__main__":
    ...
    if cmd == "init":
        ...
        for m in reversed(msgs):
            sender = "Me" if m["is_from_me"] else m["sender_name"]
